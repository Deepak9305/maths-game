                ...
                {rockets.map((rocket, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        onClick={() => !isEquipped && onEquip(rocket)}
                        disabled={isEquipped || (!isOwned && !canAfford)}
                        className={`px-4 py-2 rounded-xl font-bold text-sm transition-all transform ${
                          isEquipped
                            ? 'bg-green-500 text-white cursor-default'
                            : isOwned
                            ? 'bg-blue-500 text-white hover:bg-blue-600 shadow active:scale-95'
                            : canAfford
                            ? 'bg-yellow-400 text-yellow-900 hover:bg-yellow-500 shadow active:scale-95'
